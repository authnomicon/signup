...
describe('signup/handlers/register', function() {
  ...
  describe('handler', function() {
    ...
    it('should create user with given name and family name', function(done) {
      var passwords = new Object();
      passwords.create = sinon.stub().yieldsAsync(null, { id: '248289761001', displayName: 'Jane Doe' });
      ...
      chai.express.use(handler)
        ...
        .listen();
    }); // should create user with given name and family name
    
    it('should create user with given name', function(done) {
      var passwords = new Object();
      passwords.create = sinon.stub().yieldsAsync(null, { id: '248289761001', displayName: 'Jane Doe' });
      ...
      chai.express.use(handler)
        ...
        .listen();
    }); // should create user with given name
    
    it('should create user with family name', function(done) {
      var passwords = new Object();
      passwords.create = sinon.stub().yieldsAsync(null, { id: '248289761001', displayName: 'Jane Doe' });
